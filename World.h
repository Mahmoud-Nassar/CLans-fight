...
namespace mtm{
    ...
    class World{
        ...
        MtmSet<string> all_clan_names;

        /**
         * creates (by allocation) a new Plain/River/Mountain with area_name
         * @param area_name- name of the new area to create
         * @param type- which area to create can be Plain/River/Mountain
         * @return poiter to the new area created
         */
        static AreaPtr intiatAreaPtr(const string& area_name,AreaType type);

        /**
         * get a group with (group_name) from (this) world
         * @param group_name- name of the group to get
         * @return GroupPointer if the group exists , Pointer to NULL otherwise
         */
        GroupPointer getGroup(const string& group_name) const;

        /**
         * gets the area of group with group_name
         * @param group_name- name of the group to get its area
         * @return - name of the area in case the group was in one of the
         * areas in (this) world ,empty string otherwise
         */
        string getGroupArea(const string& group_name) const;
