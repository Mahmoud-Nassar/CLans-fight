...
namespace mtm{
    ...
    */
    class Group{
        ...
        /**
         * separate (this) group
         * separate group defntion :
         * changes children`s number adult`s number,tool`s number,food`s number
         * to be 0
         * changes clan name and group name to be an empty string ("")
         */
        void separateGroup();

        /**
    * does the necessary updates -after a fight- on the winner`s and the
    * loser`s group (the winner is this)
    * updates explanation:
    ...
    *
    * Fights effects on the winner group(this Group):
    ...
    * @param loser- loser group which needed to be updated
    */
        void updateAfterFight(Group& loser);

        /**
         * this function assumes that this group has more tools than food
         * and other`s group has more food than tools
         * does the necessary updates -after a trade- on both this and other
         * updates explanation:
         * to simplfy the explanation we define :
         * offer1=|other's food - other's tools| / 2(ceiling)
         * offer2=|this's tools - this's food| / 2(ceiling)
         * trade_value=[(offer1 + offer2)/2 (ceiling)]
         * this tools amonunt is decreased by trade_value
         * this food amount is increaesd by trade_value
         * other tools amonunt is increaesd by trade_value
         * this food amount is decreased by trade_value
         * @param other -the other group to trade with
         */
        void updateAfterTrade(Group& other);
